...
<script type="text/javascript">
  ...
  <body>
	<form id="form1" action="<c:url value='orderServlet'/>" method="post">
		...
		<input id="cartItemIds" type="hidden" name="cartItemIds" value="${cartItemIds}"/>
		...
		<table width="95%" align="center" cellpadding="0" cellspacing="0">
			...
			<c:forEach var="item" items="${listItem }">
				<tr align="center">
					<td align="right">
						<a class="linkImage" href="<c:url value='/bookServlet?method=load&bid=${item.book.bid }'/>"><img border="0" width="54" align="top" src="<c:url value='${item.book.image_w }'/>"/></a>
					</td>
					<td align="left">
			...
			<tr>
				<td colspan="6">
					<input id="addr" type="text" name="address" value="江西省 南昌市 经济开发区 广兰大道  418号 皇太子"/>
				</td>
			</tr>
			<tr>
