package com.huangss.goods.book.Dao;
...
/*	public static void main(String[] args) {
	 ...
	 * @throws SQLException 
	 */
	public int findBook(String cid) throws SQLException {
	...
	public void addBook(Book book) throws SQLException {
		...
		Object[] objs={book.getBid(), book.getBname(), book.getAuthor(), book.getPrice(),
							book.getCurrPrice(), book.getDiscount(), book.getPress(), book.getPublishtime(),
								book.getEdition(), book.getPageNum(), book.getWordNum(), book.getPrinttime(), book.getBooksize(),
